...
## 학습방식💻
1. 매일 주차별 주제 학습 및 문제 풀이 (바킹독 문제집)
2. 매주 토요일 20:00 - 22:00 해당 주차 주제 개념 정리 (블로그)
3. 매주 일요일 20:00 - 22:00 지난 주차 주제 개녕 및 문제 복습 (🥕당근 문제🥕 다시 풀기)
...
| 2  | **자료구조** (스택/큐/덱/힙) :: |
| 3  | **재귀함수**의 이해 & 여러 가지 **정렬** ::                            |
| 4  | **다이나믹 프로그래밍 (DP)** ::                              |
| 5  | **그래프** 이론과 구현 (1) & **DFS와 BFS 기초** ::                                                                                                                                                                                                             |
| 6  | **그래프** 이론과 구현 (2) & **Floyd & Dijkstra & 위상 정렬** ::                                                                                                                                                                                               |
| 7  | **분할정복 & 이분탐색** ::                                                                                                                                                                                                                                                                                   |
| 8  | **그리디 알고리즘** ::                                                                                                                                                                                                                                                                                      |
